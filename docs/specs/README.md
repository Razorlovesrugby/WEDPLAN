...
| 7 | [Cooler list colors, auto-assign on task creation, and a highlighted "today" on the calendar](07-list-colors-task-assignment-calendar-today.md) | Built end to end, same session (2026-09-16) — new `LIST_COLOR_PALETTE`, `addItem` auto-assigning to the creating user, and a highlighted today cell on `/calendar`. No schema change. | Specs 1 and 3, already built |
